...
public class TouchControlsMod {
	...
	public void syncConfig() {
		...
		config_xOffset = configFile.getInt("Touch Offset X", cat, config_xOffset, intMin, intMax, "Touch offset for the X-Axis.");
		config_yOffset = configFile.getInt("Touch Offset Y", cat, config_yOffset, intMin, intMax, "Touch offset for the Y-Axis.");
		...
		config_sensitivity = configFile.getInt("Movement Sensitivity", cat, config_sensitivity, 0, 100, "The sensitivity of touch movement.");

		config_dPadSize = configFile.getInt("D-Pad Size", cat, config_dPadSize, 10, 100, "The size of the D-pad on the screen.");
		config_dPadOpacity = configFile.getInt("D-Pad Opacity", cat, config_dPadOpacity, 50, 100, "The opacity of the D-pad on the screen.");
