package net.tschrock.minecraft.touchmanager.linux;
...
public class LinuxTouchDriver extends GenericTouchDriver {
	
	LinuxTouchDriver self;

	String procEx = "/home/tyler/CodeBlocks/XTestApp/bin/Debug/XTestApp";
	...
	public void run() {
		running = true;
		try {
			proc = Runtime.getRuntime().exec(procEx);
